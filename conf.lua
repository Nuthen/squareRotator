function love.conf(t)
    t.identity = Confusion                   -- The name of the save directory (string)
    t.version = "0.9.2"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)

    t.window.title = "Confusion Machine"        -- The window title (string)
...
config = {
    ...
    gameTitle = "Confusion Machine",
    windowTitle = "Confusion Machine",
